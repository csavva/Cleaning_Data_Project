...
Just a code book to describes the data, variables and work performed to clean up the data.
...
The R script ```run_analysis.R``` should be used to achive the above 5 objectives:
